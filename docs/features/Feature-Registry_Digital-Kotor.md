...
| ---------- | ----- | --------- | ------ | -- | -- | -- | -- |
| FT-004 | Obavještenja | PLATFORM | Infrastruktura implementirana / aktivna; signed-copy first publication + direct predecessor revoke IMPLEMENTED; KN lifecycle iz KN-BM-003 §15.4 / KN-FS-003 v0.1.21 DOCUMENTED / NOT YET IMPLEMENTED; LOCAL PO MANUAL ACCEPTANCE signed-copy toka 2026-09-01; NOT PRODUCTION DEPLOYED; E2E za ostale izvore otvoren (OFD-OB-006); dokumenti U IZRADI | DK-BM-001 | DK-UC-001 | DK-FS-001 | DK-TS-001 |
...
* Source-specific KN lifecycle — **DOCUMENTED / NOT YET IMPLEMENTED:** `KN-BM-003` v1.0.6 §15.4 / `KN-FS-003` v0.1.21 §16.8–§16.16 (poslovni naziv od KN, poslovni datum prikaza, metadata correction, source-specific unpublish, republish, puna one-current-publication semantika, revoke leftover HTML, permanent-delete channel revoke). Dokumentovano u DK-UC-001 v0.1.1, DK-FS-001 PATCH-FS-OB-003, DK-TS-001 v0.1.3. **Nije** production accepted.
...
**Kraj dokumenta DK-FR-001 v1.1.2**
