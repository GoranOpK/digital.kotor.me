...
`KN-FS-003` v1.0.12 služi samo kao strukturni obrazac i uporedni izvor. Zajednički funkcionalni obrazac smije se preuzeti samo kada **nije** suprotan `KN-BM-002`.
