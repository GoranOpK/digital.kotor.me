...
Nije poslovni pojmovnik. Ne definiše poslovna pravila ni tehnička rješenja. Ne zamjenjuje DK-BM-001, DK-BM-002, DK-UC-001, DK-FS-001, DK-FS-002, DK-TS-001, DK-TS-002, DK-FR-001 ili DK-DS-001.
...
Product Owner je otvorio dokumentacioni paket **registracije i korisničkog identiteta**. Ovaj registar mu dodjeljuje **DK-BM-002** (USVOJENO), **DK-FS-002** (USVOJENO) i **DK-TS-002** (USVOJENO). Dokument `DK-UC-002` **nije** uveden.
...
U platformskom `DK-*` sloju **nisu** uvedeni: `DK-IS-*`, `DK-IR-*`, `DK-CR-*`, `DK-FT-*`, `DK-PATCH-*`, `DK-UC-002`.
...
| **DK-TS-002** | Tehnička specifikacija registracije i korisničkog identiteta Platforme Digital Kotor | `docs/technical-specifications/Technical_Specification_Registracija_korisnickog_identiteta.md` | USVOJENO |
...
| 1.3.1 | 2026-09-05 | Status / closeout: `DK-TS-002` registrovan i evidentiran kao USVOJENO (v1.0.0). `DK-UC-002` nije uveden. Nema novih skraćenica. Istorijski red 1.3.0 neizmijenjen. DK-RG i dalje nije katalog KN oznaka. |

---

**Kraj dokumenta DK-RG-001 v1.3.1**
