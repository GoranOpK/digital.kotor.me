...
| JMB/JMBG enkripcija | Paralelne `*_encrypted` kolone; B1 service; B2 backfill (produkcija); Faza C dual-write; Faza D encrypted-first VALUE read (produkcija, prihvaćeno) | [jmb-encryption.md](jmb-encryption.md) |
