...
| JMB/JMBG enkripcija | Paralelne `*_encrypted` kolone; lookup digest; encrypted-first VALUE read; plaintext vrijednosti retired na NULL (2026-09-11, 72 reda); fizički DROP kolona nije dio closeout-a | [jmb-encryption.md](jmb-encryption.md) |
