...
| **Platforma** | JMB/JMBG enkripcija (A/B1/B2/C/D) | **A/B1/B2/C/D produkcija.** B2: 71 encrypted, verifikovano. Faza C dual-write deployovana. Faza D encrypted-first VALUE read deployovana i produkcijski prihvaćena (profil / Obrazac 1A / Obrazac 2 = PASS). SQL uniqueness ostaje plaintext. Plaintext kolone i dalje postoje. | [jmb-encryption.md](jmb-encryption.md) |
...
| [jmb-encryption.md](jmb-encryption.md) | JMB/JMBG enkripcija, produkcijski B2/C/D zapisi, rollback/plaintext status |
