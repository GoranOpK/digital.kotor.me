...
| **Platforma** | JMB/JMBG enkripcija | **6/6 CLOSED / PRODUCTION ACCEPTED.** Plaintext retired na NULL (72). Encrypted autoritativan. Lookup uniqueness. `JMB_PLAINTEXT_RETIREMENT_ENABLED=true` obavezan produkcijski runtime. Fizički DROP kolona izvan closeout-a. | [jmb-encryption.md](jmb-encryption.md) |
...
| [jmb-encryption.md](jmb-encryption.md) | JMB/JMBG enkripcija, lookup, plaintext retirement closeout, produkcijska evidencija |
