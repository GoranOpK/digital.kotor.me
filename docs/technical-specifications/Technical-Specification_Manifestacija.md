...
TS-005 obrađuje jednu logički zaokruženu funkcionalnu cjelinu unutar FT-001 i ne predstavlja kompletnu tehničku specifikaciju svih cjelina Feature-a FT-001.
...
* ne projektuje TS-003 (Događaj), TS-004 (Održavanje), TS-006–TS-012 — samo granice.
...
1. TS-005 pripada FT-001 – Kalendar kulture.
...
7. Veze prema Događaju i Održavanju moraju ostati konzistentne sa TS-003 i TS-004.
...
* lokalni audit tragovi i emisija ka centralnoj Evidenciji (granica TS-012);
* javni prikaz (granica TS-009);
* integracione granice prema TS-001, TS-003, TS-004 i ostalim planiranim TS.
...
| Zavisnost | Uloga u odnosu na TS-005 |
|-----------|---------------------------|
| TS-001 Organizator / Moderator | Opcioni Organizator; aktivni kontekst Moderatora |
| TS-003 Događaj | hasMany / belongsTo 0..1; uslovi objave; nezavisni lifecycle |
...
FT-001 Kalendar kulture
  ...
  → PO-MF-01–PO-MF-12
  → TS-005 (ovaj dokument)
  → granice: TS-001, TS-003, TS-004
```
...
TS-005 ne projektuje druge cjeline; integracije su ugovori granica (§9).
...
| Direktni pristup centralnoj Evidenciji | Ne | Ne | Da (FT-003 / TS-012) |
...
Lokalni tragovi (kao TS-003/004) za najmanje:
...
|----------|----------------|
| **TS-001** | Opcioni Org.; kontekst Moderatora |
| **TS-003** | Veza 0..1; uslov Objavljen za objavu MF; nezavisni lifecycle |
...
## 10.3 Konzistentnost sa TS-003/004
...
Nema otvorenih Product Owner pitanja za TS-005.
...
| TS-005 | BM | FS | PO | FT | Ostalo |
|--------|----|----|----|----|--------|
| §1 Pregled | BM-MF-01 | BR-092 | PO-MF-06 | FT-001 | TS-003, TS-004 |
