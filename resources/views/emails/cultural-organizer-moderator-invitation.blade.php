...
<head>
    ...
    <title>Poziv za Moderatora</title>
</head>
                ...
                <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px; width:100%; background:#ffffff; border-radius:12px; overflow:hidden; border:1px solid #e5e7eb;">
                    ...
                    <tr>
                        <td style="padding:24px;">
                            ...
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.6;">
                                Predloženi ste za ulogu Moderatora Organizatora
                                <strong>{{ $organizerName }}</strong>
                                u Kalendaru kulture Opštine Kotor.
                            </p>
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.6;">
                                Za nastavak postupka potrebno je imati aktivan i verifikovan korisnički nalog na platformi Digital Kotor.
                            </p>
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.6;">
                                Registracija je dostupna na:
                                <a href="{{ $registrationUrl }}" style="color:#7a0f17;">{{ $registrationUrl }}</a>
                            </p>
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.6;">
                                Ako već imate nalog, prijavite se i dovršite verifikaciju ili aktivaciju prema uputstvima na platformi.
                            </p>
