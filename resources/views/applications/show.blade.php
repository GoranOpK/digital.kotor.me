        ...
        <div class="info-card">
            ...
            @php
                ...
                $isPreduzetnica = in_array($application->applicant_type, ['preduzetnica', 'fizicko_lice']);
                    ...
                    $documentLabels['dokaz_ziro_racun'] = ($application->applicant_type === 'preduzetnica' && $isRazvoj) ? 'Dokaz o broju poslovnog žiro računa preduzetnice' : (($application->applicant_type === 'preduzetnica' && $isZapocinjanje) ? 'Dokaz o broju poslovnog žiro računa preduzetnice (ukoliko ima registrovanu djelatnost)' : (($isDooOstalo && $isZapocinjanje) ? 'Dokaz o broju poslovnog žiro računa društva (ukoliko ima registrovanu djelatnost)' : 'Dokaz o broju poslovnog žiro računa'));
