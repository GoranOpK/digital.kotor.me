        ...
        <div class="info-card">
            ...
            @php
                ...
                $documentLabels = [
                    ...
                    'pib_resenje' => (($application->applicant_type === 'preduzetnica' || $application->applicant_type === 'fizicko_lice') && $application->business_stage === 'započinjanje' ? 'Rješenje o PIB-u PJ Poreske uprave (ukoliko ima registrovanu djelatnost)' : ((($application->applicant_type === 'doo' || $application->applicant_type === 'ostalo') && $application->business_stage === 'započinjanje') ? 'rješenje o registraciji PJ Poreske uprave (ukoliko ima registrovanu djelatnost)' : 'Rješenje o registraciji PJ Uprave prihoda i carina')),
                    ...
                    'dokaz_ziro_racun' => ($application->applicant_type === 'preduzetnica' && $application->business_stage === 'započinjanje') ? 'Dokaz o broju poslovnog žiro računa preduzetnika (ukoliko ima registrovanu djelatnost)' : 'Dokaz o broju poslovnog žiro računa',
                    'predracuni_nabavka' => ($application->applicant_type === 'doo' || $application->applicant_type === 'ostalo') && $application->business_stage === 'započinjanje' ? 'predračune za planiranu nabavku' : 'Predračuni za planiranu nabavku',
                    'ostalo' => 'Ostalo',
                ];
            @endphp
