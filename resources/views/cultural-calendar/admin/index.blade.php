                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('cultural-events.edit', ['dogadjaji' => $event->getKey()]) }}" class="px-3 py-1.5 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                                        Uredi
                                    </a>
                                    <form method="POST" action="{{ route('cultural-events.destroy', ['dogadjaji' => $event->getKey()]) }}" onsubmit="return confirm('Da li ste sigurni da želite obrisati događaj?');">
                                        @csrf
                                        @method('DELETE')
