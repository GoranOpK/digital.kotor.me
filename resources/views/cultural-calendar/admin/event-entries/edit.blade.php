...
<div class="kk-shell mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 max-w-4xl">
        ...
        <p class="text-sm text-gray-600 mb-4">Nacrt može imati 0 ili više održavanja. Fizičko uklanjanje samo dok je događaj Nacrt (N-TR-04).</p>
        ...
        <div class="overflow-x-auto mb-6">
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-3 py-6 text-center text-gray-500">Nema održavanja (dozvoljeno u Nacrtu).</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
