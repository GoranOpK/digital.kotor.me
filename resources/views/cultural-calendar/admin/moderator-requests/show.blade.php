...
<div class="kk-shell mx-auto px-4 sm:px-6 lg:px-8 py-6 max-w-3xl">
    ...
    @elseif($requestItem->isRejected() && ! $requestItem->isDismissedByEditor())
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <form
                method="POST"
                action="{{ route('cultural-moderator-requests.dismiss', $requestItem) }}"
    ...
    <div class="mt-4">
        <a href="{{ route('cultural-editorial-requests.index', ['sekcija' => 'moderatori']) }}" class="text-sm text-gray-600 underline">Nazad na Zahtjeve</a>
    </div>
</div>
@endsection
