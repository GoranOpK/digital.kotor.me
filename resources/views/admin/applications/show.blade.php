    ...
    <div class="container mx-auto px-4">
        ...
        <div class="status-and-basic-info" style="display: grid; grid-template-columns: 1fr; gap: 16px; margin-bottom: 24px;">
                ...
                <div class="info-card">
                    ...
                    @if($isCommissionMember || $userRole === 'superadmin')
                        ...
                        <div class="info-grid" style="grid-template-columns: 1fr;">
                            ...
                            <div class="info-item" style="margin-bottom: 16px;">
                                <span class="info-label">E-mail obavještenje</span>
                                <span class="info-value">
                                    @if((int) $application->email === 1)
                ...
                @php
                        ...
                        'pib_resenje' => ($application->applicant_type === 'preduzetnica' && $application->business_stage === 'započinjanje')
                            ...
                            : ((($application->applicant_type === 'preduzetnica' || $application->applicant_type === 'fizicko_lice') && $application->business_stage === 'razvoj')
                                ...
                                : ((($application->applicant_type === 'doo' || $application->applicant_type === 'ostalo') && ($application->business_stage === 'započinjanje' || $application->business_stage === 'razvoj'))
                                    ? 'Rješenje o registraciji PJ Poreske uprave' . ($application->business_stage === 'započinjanje' ? ' (ukoliko ima registrovanu djelatnost)' : '')
                    ...
                    $documentLabels = \App\Models\Application::overlayContextualDocumentLabels(
                        $documentLabels,
                        $application->applicant_type,
