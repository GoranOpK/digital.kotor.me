        ...
        <div class="status-and-basic-info" style="display: grid; grid-template-columns: 1fr; gap: 16px; margin-bottom: 24px;">
                ...
                @php
                    ...
                    $documentLabels = [
                        ...
                        'pib_resenje' => ($application->applicant_type === 'preduzetnica' && $application->business_stage === 'započinjanje') ? 'Rješenje o PIB-u PJ Poreske uprave (ukoliko ima registrovanu djelatnost)' : 'Rješenje o registraciji PJ Uprave prihoda i carina' . (($application->applicant_type === 'doo' || $application->applicant_type === 'ostalo') && $application->business_stage === 'započinjanje' ? ' (ukoliko ima registrovanu djelatnost)' : ''),
                        ...
                        'potvrda_neosudjivanost' => ($application->applicant_type === 'preduzetnica' && $application->business_stage === 'započinjanje') ? 'Potvrda da se ne vodi krivični postupak na ime preduzetnika izdatu od strane Osnovnog suda' : (($application->applicant_type === 'doo' || $application->applicant_type === 'ostalo') && $application->business_stage === 'razvoj' ? 'Potvrda o neosuđivanosti za krivična djela na ime nosioca biznisa (osnivačice ili jedne od osnivača i izvršne direktorice) izdatu od strane Osnovnog suda' : 'Potvrda o neosuđivanosti za krivična djela na ime preduzetnice izdatu od strane Osnovnog suda'),
