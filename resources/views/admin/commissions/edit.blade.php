            ...
            <form method="POST" action="{{ route('admin.commissions.update', $commission) }}">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="start_date" class="form-control" value="{{ old('start_date', $commission->start_date->format('Y-m-d')) }}" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Datum završetka mandata *</label>
                        <input type="date" name="end_date" class="form-control" value="{{ old('end_date', $commission->end_date->format('Y-m-d')) }}" required>
                    </div>
                </div>
