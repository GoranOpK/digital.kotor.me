...
class StorePaymentTypeAvailabilityRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        ...
        $validator->after(function (Validator $validator): void {
            ...
            $type = $this->route('payment_type');
            $exists = PaymentTypeAvailability::query()
            ...
            if ($exists) {
                $validator->errors()->add('user_type', 'Ista kombinacija dostupnosti već postoji za ovu vrstu.');
            }
        });
    }
}
