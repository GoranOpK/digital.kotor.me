...
class RestrictRoleModuleAccess
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($roleName === 'kk_admin') {
            ...
            if ($routeName && str_starts_with($routeName, 'cultural-event-entries.')) {
                return $next($request);
            }
            ...
            if ($routeName && str_starts_with($routeName, 'cultural-editorial-requests.')) {
                return $next($request);
            }
        ...
        if ($roleName === 'konkurs_admin') {
            $allowedRouteNames = [
                ...
                'admin.competitions.official-decision.permanent-delete',
                'applications.create',
        ...
        if ($roleName === 'komisija') {
            $allowedRouteNames = [
                ...
                'evaluation.store',
                'evaluation.show',
                'evaluation.eliminatory.store',
                'evaluation.eliminatory.confirm',
                'evaluation.prigovor.decide',
